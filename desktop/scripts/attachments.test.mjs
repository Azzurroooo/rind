...
test("attachment limits and send composition", () => {
  ...
  assert.equal(composeMessageWithAttachments("Look at this", ["uploads/desktop/a.png"]), "Look at this\nAttachment: uploads/desktop/a.png")
  assert.equal(composeMessageWithAttachments("", ["uploads/desktop/a.png", "uploads/desktop/b.pdf"]), "Attachment: uploads/desktop/a.png\nAttachment: uploads/desktop/b.pdf")
